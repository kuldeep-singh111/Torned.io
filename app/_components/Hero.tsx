...
function Hero() {
  return (
    ...
    style={{backgroundImage: "url('/bc.jpg')",
  ...
  <div className="mx-auto h-screen max-w-screen-xl px-4 py-12 lg:flex  ">
    <div className="mx-auto max-w-xl text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-4">
        <a
          className="block w-full rounded bg-white text-black px-12 py-3 text-sm font-medium  shadow hover:bg-slate-200 focus:outline-none focus:ring active:bg-red-300 sm:w-auto"
          href="#"
        >
          Learn More
        </a>
